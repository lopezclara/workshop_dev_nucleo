...
GET	/productos	Lista con paginación y filtrado	page: número página (default 1)<br>limit: items por página (default 10)<br>categoria: filtro por categoría	curl "http://localhost:8080/productos?page=1&limit=5"<br>curl "http://localhost:8080/productos?categoria=perifericos"
